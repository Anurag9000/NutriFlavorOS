...
def validate_contract() -> dict:
    ...
    required = {
        "proxy": {
            ...
            'message_type == b"Q"',
            'message_type == b"P"',
            "def _is_commit_query",
            'query.strip().rstrip(b";").strip().upper() == b"COMMIT"',
        ...
        "proxy_tests": {
            ...
            "test_commit_query_normalization_is_strict_and_case_insensitive",
            ...
            '_is_commit_query(b"COMMIT") is True',
            '_is_commit_query(b" commit ; ") is True',
            '_is_commit_query(b"COMMIT AND CHAIN") is False',
            "_is_commit_query(None) is False",
    ...
    return {
        ...
        "commit_normalization_predicate_tested": True,
